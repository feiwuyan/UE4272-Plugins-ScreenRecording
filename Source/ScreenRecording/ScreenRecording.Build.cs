...
public class ScreenRecording : ModuleRules
{
    ...
    public bool LoadFFmpeg(ReadOnlyTargetRules Target)
    {
        ...
        if (Target.Platform == UnrealTargetPlatform.Win64)
        {
            ...
            foreach (string dllName in dllNames)
            {
                ...
                string dllFullPath = Path.Combine(BinariesPath, dllName);
                System.Console.WriteLine("ScreenRecording Plugin is trying to find DLL at: " + dllFullPath);
    ...
    public ScreenRecording(ReadOnlyTargetRules Target) : base(Target)
	{
